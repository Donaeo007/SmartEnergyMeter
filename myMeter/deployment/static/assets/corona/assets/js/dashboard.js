...
/*Round Charts */
if ($("#transaction-history-current").length) {
  var areaData = {
    labels: ["Paypal", "Stripe","Cash"],
    datasets: [{
        data: [55, 25, 20],
  ...
  var transactionhistoryChartCanvas2 = $("#transaction-history-current").get(0).getContext("2d");
  var transactionhistoryChart2 = new Chart(transactionhistoryChartCanvas2, {
    type: 'doughnut',
    data: areaData,
    options: areaOptions,
    plugins: transactionhistoryChartPlugins
